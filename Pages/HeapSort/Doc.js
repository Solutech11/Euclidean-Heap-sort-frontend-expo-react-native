  ...
  return (
    ...
    <SafeAreaView style={[GeneralStyle.Container,{alignItems:'center', paddingTop:0}]}>
        ...
        <View style={styles.toptextContainer}>
          <Text style={[TextStyleStyle._38Sen800,{textAlign:'center'}]}>Heap Sort{`\n`}Documentation</Text>
        </View>
        ...
        <View style={styles.BodyContainer}>
            <ScrollView showsVerticalScrollIndicator={false} overScrollMode='never'>
                <Pressable>
                <Text style={TextStyleStyle._20Signika400}>{Documentaion.HeapSort}</Text>
                </Pressable>
